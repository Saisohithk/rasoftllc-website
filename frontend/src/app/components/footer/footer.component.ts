        ...
        <div class="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-12 mb-12">
          <div>
            <a href="#" class="flex items-center gap-3 mb-4">
              <div class="w-9 h-9 bg-[#E8280B] flex items-center justify-center font-heading text-sm text-white font-bold" style="clip-path:polygon(0 0,90% 0,100% 10%,100% 100%,10% 100%,0 90%)">RA</div>
              <span class="font-heading text-xl tracking-[3px] text-white">RA SOFT <span class="text-[#E8280B]">LLC</span></span>
            </a>
            <p class="text-sm text-white/40 leading-relaxed max-w-[260px] font-light">Premier IT staffing and workforce solutions for federal, commercial, and cleared environments. Serving clients nationwide from Laurel, Maryland.</p>
            <div class="mt-6 flex flex-col gap-3">
              <div class="flex items-center gap-3 text-xs text-white/40">📧 talent&#64;rasoftllc.com</div>
              <div class="flex items-center gap-3 text-xs text-white/40">📞 (720) 560-3742</div>
              <div class="flex items-center gap-3 text-xs text-white/40">📍 Laurel, Maryland, USA</div>
            </div>
          </div>
