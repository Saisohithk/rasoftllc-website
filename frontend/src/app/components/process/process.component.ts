  ...
  template: `
    <section class="py-24 px-[5vw] bg-[#0b0e18]">
      <div class="max-w-7xl mx-auto">
        <div class="flex items-center gap-3 text-[#E8280B] text-xs font-bold tracking-[2.5px] uppercase mb-4"><span class="w-6 h-px bg-[#E8280B]"></span>Our Process</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.04]">
          @for (step of steps; track step.num) {
            <div class="bg-[#0b0e18] p-7">
              <div class="w-14 h-14 bg-[#07090f] border border-white/[0.10] flex items-center justify-center font-heading text-lg text-[#E8280B] mb-6" style="clip-path:polygon(0 0,85% 0,100% 15%,100% 100%,15% 100%,0 85%)">{{step.num}}</div>
